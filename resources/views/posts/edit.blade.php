                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('posts.update', $post->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="content" name="content" class="block mt-1 w-full bg-white text-gray-900 border-gray-300 focus:border-burnt-orange focus:ring-burnt-orange rounded-md shadow-sm" rows="15" required>{{ old('content', $post->content) }}</textarea>
                        ...
                        @if($post->featured_image)
                            <div class="mb-4">
                                ...
                                <img src="{{ asset('storage/' . $post->featured_image) }}" alt="Current featured image" class="mt-2 max-w-xs rounded-md shadow-sm">
                            </div>
                        @endif
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Upload a new featured image (JPG, PNG, GIF - Max 2MB)</p>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="image" class="block mt-1 w-full" type="url" name="image" :value="old('image', $post->image)" placeholder="https://example.com/image.jpg" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="video_url" class="block mt-1 w-full" type="url" name="video_url" :value="old('video_url', $post->video_url)" placeholder="https://www.youtube.com/watch?v=..." />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="subcategory_id" name="subcategory_id" class="block mt-1 w-full bg-white text-gray-900 border-gray-300 focus:border-burnt-orange focus:ring-burnt-orange rounded-md shadow-sm">
                                ...
                                @foreach($subcategories as $subcategory)
                                    <option value="{{ $subcategory->id }}" {{ old('subcategory_id', $post->subcategory_id) == $subcategory->id ? 'selected' : '' }}>{{ $subcategory->category->name }} → {{ $subcategory->name }}</option>
                                @endforeach
                            </select>
