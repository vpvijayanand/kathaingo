                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.categories.update', $category->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="block mt-1 w-full bg-white text-gray-900 border-gray-300 focus:border-burnt-orange focus:ring-burnt-orange rounded-md shadow-sm" rows="4">{{ old('description', $category->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="order" class="block mt-1 w-full" type="number" name="order" :value="old('order', $category->order)" />
